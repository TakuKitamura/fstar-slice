...
void print_slice (uint32_t *u32_array, uint32_t u32_array_length, uint32_t from, uint32_t to) {
...
int main() {
  ...
  print_slice(u32_array, u32_array_length, 0, 5);
  print_slice(u32_array, u32_array_length, 2, 4);
  print_slice(u32_array, u32_array_length, 5, 0);
  return 0;
}